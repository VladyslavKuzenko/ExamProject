...
namespace EasyLearn.SqlLiteDb.Migrations
{
    ...
    [Migration("20241011191541_InitialCreate")]
            ...
            modelBuilder.Entity("EasyLearn.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "user123",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cbb35ceb-3a41-4670-b4e3-ffa7d4752153",
                            ...
                            SecurityStamp = "f0c8a1f6-5cce-40a1-908d-d0290241d6d3",
                        ...
                        new
                        {
                            Id = "user456",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f4d1ab62-7613-4006-8113-3ec44096f2d3",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMJP9v5ZC",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "53d03ac5-4acd-4fab-bb22-2a196a31d06b",
                            TwoFactorEnabled = false,
                            UserName = "testuser2"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7482),
                            Description = "Basic course for C# programming",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7533),
                        ...
                        {
                            Id = 2,
                            Create = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7536),
                            Description = "Advanced topics in C#",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7537),
                            Name = "Advanced C#",
                            UserId = "user456"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Folder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            Create = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7570),
                            Description = "Introductory folder",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7572),
                            Name = "Introduction",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            CourseId = 2,
                            Create = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7575),
                            Description = "Folder with advanced topics",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7576),
            ...
            modelBuilder.Entity("EasyLearn.Models.TrainingModule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7606),
                            Description = "Learn the basics of C#",
                            FolderId = 1,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7609),
                            Name = "C# Basics",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            Create = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7612),
                            Description = "Learn advanced C# features",
                            FolderId = 2,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 22, 15, 39, 762, DateTimeKind.Local).AddTicks(7613),
