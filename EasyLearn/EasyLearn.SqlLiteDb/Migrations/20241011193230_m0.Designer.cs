            ...
            modelBuilder.Entity("EasyLearn.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "user123",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3581a4cd-5fc7-4989-96c9-d38704371453",
                            ...
                            SecurityStamp = "0f7a9aac-0966-4a2e-a027-e02b75b671d1",
                        ...
                        new
                        {
                            Id = "user456",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "eb83aaab-77fa-4803-ba8a-1fbf78f4789a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMJP9v5ZC",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "78be4f47-28fd-4744-b8bb-5fe247a851e3",
                            TwoFactorEnabled = false,
                            UserName = "testuser2"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(4985),
                            Description = "Basic course for C# programming",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5032),
                        ...
                        {
                            Id = 2,
                            Create = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5035),
                            Description = "Advanced topics in C#",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5036),
                            Name = "Advanced C#",
                            UserId = "user456"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Folder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            Create = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5056),
                            Description = "Introductory folder",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5057),
                            Name = "Introduction",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            CourseId = 2,
                            Create = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5060),
                            Description = "Folder with advanced topics",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5061),
            ...
            modelBuilder.Entity("EasyLearn.Models.TrainingModule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5081),
                            Description = "Learn the basics of C#",
                            FolderId = 1,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5082),
                            Name = "C# Basics",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            Create = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5086),
                            Description = "Learn advanced C# features",
                            FolderId = 2,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 10, 11, 21, 32, 30, 461, DateTimeKind.Local).AddTicks(5087),
