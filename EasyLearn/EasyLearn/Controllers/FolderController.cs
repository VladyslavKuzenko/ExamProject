...
namespace EasyLearn.Controllers
{
    ...
    public class FolderController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Folder>>> GetNomenclature()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Folder>> GetNomenclature(int id)
        {
            var nomenclature = await _context.Folder.FindAsync(id);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutNomenclature(int id, Folder nomenclature)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Folder>> PostNomenclature(Folder nomenclature)
        {
            _context.Folder.Add(nomenclature);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteNomenclature(int id)
        {
            ...
            _context.Folder.Remove(nomenclature);
            await _context.SaveChangesAsync();
