            ...
            modelBuilder.Entity("EasyLearn.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "user123",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a77d1367-2519-4a03-a162-92920ce4357c",
                            ...
                            SecurityStamp = "ce6bad61-ddf6-4978-884f-1ced4a2a328c",
                        ...
                        new
                        {
                            Id = "user456",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "44d29c5d-cbc5-41e9-9651-da65c335bbe4",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMJP9v5ZC",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9dea162c-2254-48be-871f-d3187e7d8aa4",
                            TwoFactorEnabled = false,
                            UserName = "testuser2"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6759),
                            Description = "Basic course for C# programming",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6826),
                        ...
                        {
                            Id = 2,
                            Create = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6829),
                            Description = "Advanced topics in C#",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6831),
                            Name = "Advanced C#",
                            UserId = "user456"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Folder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            Create = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6873),
                            Description = "Introductory folder",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6875),
                            Name = "Introduction",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            CourseId = 2,
                            Create = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6880),
                            Description = "Folder with advanced topics",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6882),
            ...
            modelBuilder.Entity("EasyLearn.Models.TrainingModule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6916),
                            Description = "Learn the basics of C#",
                            FolderId = 1,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6920),
                            Name = "C# Basics",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            Create = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6925),
                            Description = "Learn advanced C# features",
                            FolderId = 2,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 17, 7, 1, 283, DateTimeKind.Local).AddTicks(6926),
