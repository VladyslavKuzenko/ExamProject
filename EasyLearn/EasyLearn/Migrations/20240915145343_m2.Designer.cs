            ...
            modelBuilder.Entity("EasyLearn.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "user123",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "01dfe6f3-d1e5-4ce7-9996-6612dce3eee1",
                            ...
                            SecurityStamp = "ccb73965-3783-4b35-9ec2-a1fcdb998fa8",
                        ...
                        new
                        {
                            Id = "user456",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "827eb787-ebf9-4d37-bf09-9d39f60ad0f5",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMJP9v5ZC",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c874c0f6-cac5-4f19-86a8-eef8be58a7dd",
                            TwoFactorEnabled = false,
                            UserName = "testuser2"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1309),
                            Description = "Basic course for C# programming",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1358),
                        ...
                        {
                            Id = 2,
                            Create = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1365),
                            Description = "Advanced topics in C#",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1366),
                            Name = "Advanced C#",
                            UserId = "user456"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Folder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            Create = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1388),
                            Description = "Introductory folder",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1390),
                            Name = "Introduction",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            CourseId = 2,
                            Create = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1392),
                            Description = "Folder with advanced topics",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1394),
            ...
            modelBuilder.Entity("EasyLearn.Models.TrainingModule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1415),
                            Description = "Learn the basics of C#",
                            FolderId = 1,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1416),
                            Name = "C# Basics",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            Create = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1419),
                            Description = "Learn advanced C# features",
                            FolderId = 2,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 16, 53, 42, 628, DateTimeKind.Local).AddTicks(1420),
