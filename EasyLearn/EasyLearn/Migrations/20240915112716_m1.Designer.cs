            ...
            modelBuilder.Entity("EasyLearn.Data.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "user123",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3244dd3a-4ca1-4a83-90e5-5cfeb732d66b",
                            ...
                            SecurityStamp = "a51b6afb-249b-449d-8ea4-1b0fad7e3266",
                        ...
                        new
                        {
                            Id = "user456",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b6eadd41-5b87-4642-96bd-91d8c0d06729",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMJP9v5ZC",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "f6931657-afbd-4a82-a9bb-22a444283f7b",
                            TwoFactorEnabled = false,
                            UserName = "testuser2"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5781),
                            Description = "Basic course for C# programming",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5836),
                        ...
                        {
                            Id = 2,
                            Create = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5838),
                            Description = "Advanced topics in C#",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5840),
                            Name = "Advanced C#",
                            UserId = "user456"
                        });
                });
            ...
            modelBuilder.Entity("EasyLearn.Models.Folder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            Create = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5865),
                            Description = "Introductory folder",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5866),
                            Name = "Introduction",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            CourseId = 2,
                            Create = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5871),
                            Description = "Folder with advanced topics",
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5872),
            ...
            modelBuilder.Entity("EasyLearn.Models.TrainingModule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Create = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5896),
                            Description = "Learn the basics of C#",
                            FolderId = 1,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5897),
                            Name = "C# Basics",
                            UserId = "user123"
                        },
                        new
                        {
                            Id = 2,
                            Create = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5900),
                            Description = "Learn advanced C# features",
                            FolderId = 2,
                            IsLearned = false,
                            LastOpen = new DateTime(2024, 9, 15, 13, 27, 16, 53, DateTimeKind.Local).AddTicks(5901),
